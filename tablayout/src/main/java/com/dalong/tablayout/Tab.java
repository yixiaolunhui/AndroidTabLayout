...
public class Tab {
    ...
    public Tab(String tabName, int tabNameUnSelectColor, int tabNameSelectColor, int tabUnSelectIcon, int tabSelectIcon, String tabUnSelectUrl, String tabSelectUrl) {
